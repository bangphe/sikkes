	...
	<form name="form_program" enctype="multipart/form-data" method="post" action="<?php echo base_url().'index.php/master_data/master_program/update_program/'.$KodeProgram; ?>">
		<table width="80%" height="25%">
            ...
            <tr>
				...
				<td width="70%"><?php $js = 'id="unit_organisasi" style="width:67%; padding:2px;" disabled="disabled"'; echo form_dropdown('unit_organisasi', $unit_organisasi, $selected_unit_organisasi, $js); ?></td>
			</tr>
			<tr>
				<td width="10%">Program</td>
				<td width="70%"><textarea id="program" name="program" style="width:45%" readonly="TRUE" rows="3"><?php echo $program; ?></textarea></td>
			</tr>
			<tr>
				<td width="10%">Output</td>
				<td width="70%"><textarea id="output" name="output" style="width:45%" readonly="TRUE" rows="4"><?php echo $output; ?></textarea></td>
			</tr>
            <tr>
				<td width="10%">Status</td>
				<td width="70%"><?php $js = 'id="status" style="width:10%; padding:2px;" disabled="disabled"'; echo form_dropdown('status',$status,$selected_status,$js); ?></td>
			</tr>
            <tr>
                <td>
                    <div class="buttons">
