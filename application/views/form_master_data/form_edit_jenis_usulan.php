...
<div id="content_master">
	<form class="appnitro" name="form_edit_jenis_usulan" enctype="multipart/form-data" method="post" action="<?php echo base_url().'index.php/master_data/master_jenis_usulan/update/'.$KodeJenisUsulan; ?>">
	...
	<table width="80%" height="25%">
        	...
        	<tr>
				...
				<td width="70%"><input type="text" name="JenisUsulan" id="JenisUsulan" style="width:60%; padding:4px" value="<?php echo $JenisUsulan; ?>" /></td>
			</tr>
            <tr>
				<td></td>
				<td>
