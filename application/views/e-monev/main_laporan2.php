...
function save_data_jadual_pelaksanaan(){
	...
	{
		$.ajax({
		url: '<?php echo base_url()?>index.php/e-monev/laporan_monitoring/save_data_jadual_pelaksanaan/'+d_skmpnen_id,
		global: false,
		type: 'POST',
		async: false,
		dataType: 'html',
...
function save_data_detail_prakontrak(){
	...
	{
		$.ajax({
		url: '<?php echo base_url()?>index.php/e-monev/laporan_monitoring/save_data_detail_prakontrak/'+d_skmpnen_id,
		global: false,
		type: 'POST',
		async: false,
		dataType: 'html',
...
function update_detail_prakontrak()
{
	...
	{
		$.ajax({
		url: '<?php echo base_url()?>index.php/e-monev/laporan_monitoring/update_data_detail_prakontrak/'+d_skmpnen_id,
		global: false,
		type: 'POST',
		async: false,
		dataType: 'html',
...
function delete_jadual_pelaksanaan(jadual_pelaksanaan_id)
{
	if (confirm("Are you sure you want to delete")) {
		$.ajax({
			url: '<?php echo base_url()?>index.php/e-monev/laporan_monitoring/delete_jadual_pelaksanaan/'+jadual_pelaksanaan_id,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'html',
