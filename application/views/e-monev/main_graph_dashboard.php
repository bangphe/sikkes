...
$(document).ready(function(){
  get_html_data(base_url+"index.php/e-monev/dashboard/grafik",'','profile_detail_loading', 'grafik1');
});
</script>
<div id="tengah">
<div id="judul" class="title">
	GRAFIK DASHBOARD KEMENTERIAN <?php echo  $this->general->konversi_bulan($bulan).' '.$thang; ?>
</div>
<br />
<div class="buttons">
    <?php echo  anchor(site_url('e-monev/dashboard/'),img(array('src'=>'images/main/back.png','border'=>'0','alt'=>'')).'Back'); ?>
</div>
<br />
<br />
<?php
