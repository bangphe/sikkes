<script type="text/javascript">
    ...
    function save_upaya(id_permasalahan){
        ...
        $.ajax({
            url: '<?php echo  base_url() ?>index.php/e-monev/laporan_monitoring/save_penyelesaian/'+id_permasalahan,
            global: false,
            type: 'POST',
            async: false,
            dataType: 'html',
    ...
    function edit(id){
        ...
        var url = '<?php echo  base_url() ?>index.php/e-monev/laporan_monitoring/get_penyelesaian/'+id;
    ...
    function update_upaya(){
        ...
        $("#data-table").html('<img src="<?php echo  base_url() . 'images/flexigrid/load.gif'; ?>"> saving...');
        $.ajax({
            url: '<?php echo  base_url() ?>index.php/e-monev/laporan_monitoring/update_penyelesaian/'+id_upaya_penyelesaian,
            global: false,
            type: 'POST',
            async: false,
            dataType: 'html',
    ...
    function hapus(id_permasalahan, id_penyelesaian){
        ...
        $.ajax({
            url: '<?php echo  base_url() ?>index.php/e-monev/laporan_monitoring/hapus_penyelesaian/',
            global: false,
            type: 'POST',
            async: false,
            dataType: 'html',
