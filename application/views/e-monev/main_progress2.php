...
$.ajax({
		url: '<?php echo base_url()?>index.php/e-monev/laporan_monitoring/cek_rencana_kontraktual/'+idpaket+'/'+bulan,
		global: false,
		type: 'POST',
		async: false,
		dataType: 'json',
...
var progress = $("#progress").val();
$.ajax({
		url: '<?php echo base_url()?>index.php/e-monev/laporan_monitoring/cek_rencana_swakelola/'+idpaket+'/'+bulan,
		global: false,
		type: 'POST',
		async: false,
		dataType: 'json',
