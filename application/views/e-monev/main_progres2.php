...
function spm(d_skmpnen_id,spm_id, bulan){
    $.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/cek_rencana_progres_keuangan/'+d_skmpnen_id+'/'+bulan,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'json',
...
function save_data(id3,id4){
		...
		$.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/save_progres3/'+id3+'/'+id4,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'json',
...
function save_data_spm(spm_id){
		...
		if(nomor_spm == '' || kdakun == '' || nominal == ''){
			...
			$.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/save_data_spm/'+spm_id,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'json',
...
function save_data_sp2d(sp2d_id){
		...
		$.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/save_data_sp2d/'+sp2d_id,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'json',
...
function delete_data_sp2d(sp2d_id,data_sp2d_id){
		$.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/delete_sp2d/'+data_sp2d_id,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'html',
...
function delete_data_spm(spm_id,sp2d_id){
		$.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/delete_spm/'+sp2d_id,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'html',
