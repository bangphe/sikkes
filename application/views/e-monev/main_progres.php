...
function update(id2,id, bulan){
    $.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/cek_rencana_progres_fisik/'+id2+'/'+bulan,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'json',
...
function update3(d_skmpnen_id,id, bulan){
    $.ajax({
			url: '<?=base_url()?>index.php/e-monev/laporan_monitoring/cek_rencana_progres_fisik/'+d_skmpnen_id+'/'+bulan,
			global: false,
			type: 'POST',
			async: false,
			dataType: 'json',
