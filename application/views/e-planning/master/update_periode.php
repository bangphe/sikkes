				...
				<td>
					<select name="periode_awal">
						<?php
							...
							while($temp < $periode){
						?>
						<option <?php if($temp==$selected_periode_awal) echo "selected"; ?> value="<?php echo  $temp; ?>"><?php echo  $temp; ?></option>
						<?php
							$temp++;
							} 
						?>
				...
				<td>
					<select name="periode_akhir">
						<?php
							...
							while($temp > $periode){
						?>
						<option <?php if($temp==$selected_periode_akhir) echo "selected"; ?> value="<?php echo  $temp; ?>"><?php echo  $temp; ?></option>
						<?php
							$temp--;
							} 
						?>
