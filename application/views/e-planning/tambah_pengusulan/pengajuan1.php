		...
		<table width="100%" height="1%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="85%"><?php
					...
					echo form_dropdown('rencana_anggaran',$rencana_anggaran,null,$js); ?>
				</td>
			<tr>
		</table>
			...
			<table width="100%" height="19%">
				<tr>
					...
					<tr>
						...
						<td>
							<?php
							if($selected_worker!=NULL) $disabled = "disabled='disabled' style='width:50%; padding:3px;'";
					...
					<tr>
						...
						<tr>
							...
							<tr>
								...
								<td><p>
									<input name="tanggal_pembuatan" id="tanggal_pembuatan" type="text" style="padding:3px;" /> (hh-bb-tttt)
								</p></td>
							</tr>
							<tr>
		...
		<?php /*<tr>
			...
			<table width="100%" height="10%">
				<tr>
					...
					<td><p>
						<input name="tanggal_mulai" id="tanggal_mulai" type="text" style="padding:3px;"/> (hh-bb-tttt)
					</p></td>
				</tr>
				<tr>
					<td style="padding-left:10px;vertical-align:top;">Tanggal Selesai*</td>
					<td><p>
						<input name="tanggal_selesai" id="tanggal_selesai" type="text" style="padding:3px;" /> (hh-bb-tttt)
					</p></td>
				</tr>
			</table>
			...
			<table width="100%" height="3%">
				<div>
					<tr>
						...
						<td width="85%"><select id="fungsi" name="fungsi" onchange="get_sub(this.value);" style="width:75%; padding:3px;">
		...
		<table width="100%" height="3%">
			<div>
				<tr>
					...
					<td width="85%"><select id="subfungsi_" name="subfungsi_" style="width:75%; padding:3px;">
			...
			<table width="100%" height="3%">
				<div>
					<tr>
						...
						<td><label>
							<select id="program" name="program" onchange="get_keg(this.value); get_outcome(this.value), get_iku(this.value)" style="width:75%; padding:3px;">
				...
				<table width="100%" height="8%">
					<div>
						...
						<tr>
							...
							<td><label>
								<select id="kegiatan_" name="kegiatan_" onchange="get_output(this.value); get_ikk(this.value)" style="width:75%; padding:3px;">
