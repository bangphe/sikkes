...
<script type="text/javascript">
	...
	{
	var a=document.forms["form_edit_telaah_staff"]["tanggal"].value;
	var b=document.forms["form_edit_telaah_staff"]["persoalan"].value;
	var c=document.forms["form_edit_telaah_staff"]["praanggapan"].value;
	var d=document.forms["form_edit_telaah_staff"]["fakta_yang_mempengaruhi"].value;
	var e=document.forms["form_edit_telaah_staff"]["cost_efektif"].value;
	var f=document.forms["form_edit_telaah_staff"]["efisien"].value;
	var g=document.forms["form_edit_telaah_staff"]["feasibilitas"].value;
	var h=document.forms["form_edit_telaah_staff"]["equity"].value;
	var i=document.forms["form_edit_telaah_staff"]["gap_daerah"].value;
	var j=document.forms["form_edit_telaah_staff"]["analisis"].value;
	var k=document.forms["form_edit_telaah_staff"]["simpulan"].value;
	// var l=document.forms["form_edit_telaah_staff"]["dari"].checked;
	// var m=document.forms["form_edit_telaah_staff"]["kepada"].checked;
