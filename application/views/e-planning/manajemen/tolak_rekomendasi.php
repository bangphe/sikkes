...
<div id="content">
	<form class="appnitro" name="form_tolak_rekomendasi" id="form_tolak_rekomendasi" enctype="multipart/form-data" method="post" action="<?php echo  base_url().'index.php/e-planning/manajemen/tolak_rekomendasi_step2/'.$kd_pengajuan; ?>">
