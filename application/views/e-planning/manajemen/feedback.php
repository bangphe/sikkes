	...
	<form class="appnitro" name="form_feedback" enctype="multipart/form-data" method="post" action="<?php echo  base_url().'index.php/e-planning/manajemen/save_feedback/'.$perintah.'/'.$kd_pengajuan;?>" onsubmit="return validateForm()">
          ...
          <td><p>&nbsp;</p>
            <table width="100%" height="1%" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <p>&nbsp;</p></td>
                  <td><p><input name="tanggal" id="tanggal" type="text" /> (hh-bb-tttt)</p></td>
                   <p>&nbsp;  </p>
                </div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <p>&nbsp; </p></td>
                <td><p>
                  <input name="nomor_surat" type="text" size="32" />
                </p>
                <p>&nbsp; </p></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><p>
                  <textarea name="umpan_balik"></textarea>
                </p>
			  ...
			  <?php if($kode_jenis_satker == 1 ||$kode_jenis_satker == 2){ ?>
              <tr>
	  ...
	  <blockquote>
	    <p style="padding-left:50px;">
		  ...
		  <input name="preview" type="submit" id="simpan" value="Simpan" />
        </p>
      </blockquote>
	</form>
</div>
