...
class Referensi2 extends CI_Controller {
			...
			function save_data(){
				$.ajax({
					...
					data:{
						...
						periode_awal:document.form_tambah_visi.periode_awal.value,
						periode_akhir:document.form_tambah_visi.periode_akhir.value,
			...
			function update_data(IdVisi){
				$.ajax({
					...
					data:{
						...
						periode_awal:document.form_update_visi.periode_awal.value,
						periode_akhir:document.form_update_visi.periode_akhir.value,
	...
	function grid_list_visi(){
		...
		foreach ($records['records']->result() as $row){
			if ($row->idPeriode != 0) {
				$periode_awal = $this->refmo->get_periode_awal($row->idPeriode);
				$periode_akhir = $this->refmo->get_periode_akhir($row->idPeriode);
			} else {
			...
			function save_data(){
				$.ajax({
					...
					data:{
						...
						periode_awal:document.form_tambah_misi.periode_awal.value,
						periode_akhir:document.form_tambah_misi.periode_akhir.value,
			...
			function update_data(IdMisi){
				$.ajax({
					...
					data:{
						...
						periode_awal:document.form_update_misi.periode_awal.value,
						periode_akhir:document.form_update_misi.periode_akhir.value,
